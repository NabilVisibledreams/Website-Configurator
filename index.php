...
<body>
	...
	<form>
		...
		<div class="page" data-page="3">
			...
			<br>
			<div id="uploadContainer"><input type="file" name="content" id="contentFile"><label for="contentFile">Klik om uw content te uploaden (pdf, jpg, png, zip, doc, docx)</label></div>
			<p>&zwnj;</p>
